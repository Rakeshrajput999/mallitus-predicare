...
def st_diabatic(diabatic_html,width =1000,height ="auto"):
  diabatic_file =codecs.open(diabatic_html,'r')
  page= diabatic_file.read()
  stc.html(page,width=width,height=height,scrolling=True)

filepath= os.path.join(os.getcwd(),'assets/diabetes.csv')
# df = pd.read_csv(r'/home/rakesh/Documents/majorProject/streamlit-navbar-flaskless/assets/diabetes.csv')
